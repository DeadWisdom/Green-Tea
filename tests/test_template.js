...
new Tea.Testing.Suite({
    ...
    test_basics : function()
    {
        ...
        var t = new Tea.Template('Bugs should all be {{ states.finished }}.');
    ...
    test_throwing : function()
    {
        ...
        var context = {};
        var t = new Tea.Template('{{name}} bugs.', {missing_throws: true});
